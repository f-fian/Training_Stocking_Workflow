...
public class StockingTempHeaderInfoModel {
    private String id;
    ...
    public StockingTempHeaderInfoModel(String id, String system_matter_id, String user_data_id, String status,
    ...
    public StockingTempHeaderInfoModel() {
