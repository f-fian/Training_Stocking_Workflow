    ...
    <workflow:workflowOpenPage name="workflowOpenPageForm"
        ...
        <div class="imui-form-container-full">
            ...
            <table class="imui-form">
                <tbody>
                    <tr>
                        <th><label for="f_nama_produk">Nama Produk</label></th>
                        <td><imui:textbox id="f_nama_produk" name="f_nama_produk"
                                style="width: 200px;" /></td>
                    </tr>
                    <tr>
                        <th><label for="f_kategori">Kategori</label></th>
                        <td><select name="f_kategori" id="f_kategori"
                            style="width: 212px;">
                    ...
                    <tr>
                        ...
                        <td><input type="number" id="f_harga" name="f_harga"
                            style="width: 200px;"></td>
                    </tr>
                    <tr>
                        <th><label for="stok">Stok</label></th>
                        <td><input type="number" id="f_stok" name="f_stok"
                            style="width: 200px;"></td>
                    </tr>
                </tbody>
            </table>
