...
<imui:head>
    ...
    <link rel="stylesheet" href="im_workflow/css/im_workflow.css"
        type="text/css">
    ...
    <div class="imui-form-container-full">
        ...
        <table class="imui-form" id="detail-table">
            ...
            <tbody class="contract_insert_detail">
                        ...
                        <!-- Loop Item already from data table -->
                        <c:forEach items="${StockingFormClassRows.detailData}" var="detailModel">
                        	<tr>
                        		<td>${detailModel.nama_produk}</td>
                        		<td>${detailModel.kategori}</td>
                        		<td>${detailModel.harga}</td>
                        		<td>${detailModel.stok}</td>
        ...
        <table class="Imui-form">
            <tbody>
                <c:forEach items="${ContractFormClassRows.d_list_info_temp_file}"
                    var="v_item_file">
                    <tr>
                        <td><a href="gpr_contract/download/${v_item_file.id}">${v_item_file.file_name}</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
